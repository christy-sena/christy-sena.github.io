...
const Footer = () => {
  ...
  <div className="grid md:grid-cols-2 gap-12 mb-12">
          ...
          <div>
            ...
            <div className="space-y-3 text-sm text-primary-foreground/70">
              <div className="flex items-center space-x-2 group">
                ...
                <a href="mailto:contact@senastrategy.ai" className="hover:text-primary-foreground transition-all duration-300 relative">
                  contact@senastrategy.ai
              ...
              <div className="flex items-center space-x-2 group">
                ...
                <a href="https://linkedin.com/company/sena-strategy-ai" className="hover:text-primary-foreground transition-all duration-300 relative">
                  Sena Strategy
                  <span className="absolute -bottom-0.5 left-0 w-0 h-px bg-primary-foreground group-hover:w-full transition-all duration-300" />
                </a>
              </div>
          ...
          {/* second column intentionally left for Contact (two-column layout) */}
        </div>
